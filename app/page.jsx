        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="overflow-hidden rounded-lg">
              <img src="/doenerteller.png" alt="Dönerteller" className="w-full h-72 object-cover object-bottom hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden rounded-lg">
              <img src="/doenerteller2.png" alt="Dönerteller" className="w-full h-72 object-cover object-bottom hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden rounded-lg">
              <img src="/kisir.png" alt="Kisir" className="w-full h-72 object-cover object-bottom hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden rounded-lg">
              <img src="/innenraum.png" alt="Innenraum" className="w-full h-72 object-cover object-bottom hover:scale-105 transition-transform duration-500" />
            </div>
          </div>
        </div>
      </section>
